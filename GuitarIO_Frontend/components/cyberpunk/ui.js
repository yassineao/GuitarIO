...
function makeTextBase(classNameDefault, AsDefault) {
  return function TextBase({ $as, children, className = "" }) {
    const AsComponent = $as || AsDefault;
    return (
      <AsComponent className={`${classNameDefault} ${className}`.trim()}>
        {children}
      </AsComponent>
    );
  };
...
export function Pad({ children, renderCap = null }) {
  return (
    <div className="pad">
      {renderCap && <div className="pad__cap">{renderCap()}</div>}
...
export const IconFeedMute = makeIcon(
...
export const IconFeedSettings = makeIcon(
...
export const IconMenuMore = makeIcon(
  <path d="M12 18c1.657 0 3 1.343 3 3s-1.343 3-3 3-3-1.343-3-3 1.343-3 3-3zm0-9c1.657 0 3 1.343 3 3s-1.343 3-3 3-3-1.343-3-3 1.343-3 3-3zm0-9c1.657 0 3 1.343 3 3s-1.343 3-3 3-3-1.343-3-3 1.343-3 3-3z" />
);

export const IconFeedAdd = makeIcon(
  <path d="M24 10h-10v-10h-4v10h-10v4h10v10h4v-10h10z" />
);

export const IconSearchSubmit = makeIcon(
  <path d="M21.172 24l-7.387-7.387c-1.388.874-3.024 1.387-4.785 1.387-4.971 0-9-4.029-9-9s4.029-9 9-9 9 4.029 9 9c0 1.761-.514 3.398-1.387 4.785l7.387 7.387-2.828 2.828zm-12.172-8c3.859 0 7-3.14 7-7s-3.141-7-7-7-7 3.14-7 7 3.141 7 7 7z" />
);

export const IconShop = makeIcon(
